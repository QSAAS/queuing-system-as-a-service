...
import MetadataSpecificationDropdownFieldBuilder from "@tests/Command/Domain/ValueObject/Builder/MetadataSpecificationDropdownFieldBuilder";
import MetadataSpecificationTextFieldBuilder from "@tests/Command/Domain/ValueObject/Builder/MetadataSpecificationTextFieldBuilder";
...
export default class MetadataSpecificationBuilder {
  ...
  constructor() {
    this.fields = [
      new MetadataSpecificationDropdownFieldBuilder().build(),

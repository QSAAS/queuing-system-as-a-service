...
export default class AdministratedOrganizationEmployeeBuilder extends OrganizationEmployeeBuilder {
  ...
  constructor() {
    super();
    this.administrated = new OrganizationEmployeeBuilder()
      .withOrganizationEmployeeId(this.organizationEmployeeId)
  ...
  public build(): AdministratedOrganizationEmployee {
    return new AdministratedOrganizationEmployee(
      this.admin,
      this.administrated,
